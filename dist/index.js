...
var sassdocToSnippets = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            ...
            files = _glob.glob.sync("".concat(src, "**/*.scss"));
          ...
          case 17:
            parseResults = _context.sent;
            parseResults.length > 0 && (_data = data).push.apply(_data, _toConsumableArray(parseResults));
          case 19:
            _context.next = 13;
            break;
          case 21:
          ...
          case 31:
            ...
            _context.next = 34;
            return (0, _scssSassdocParser.parse)(src);
          case 34:
            _parseResults = _context.sent;
            (_data2 = data).push.apply(_data2, _toConsumableArray(_parseResults));
            _context.next = 40;
            break;
          case 38:
          ...
          case 40:
            ...
            data = (0, _utils.dedupe)(data);

            // Format data based on chosen format
            _context.t1 = format;
            _context.next = _context.t1 === "neosnippet" ? 45 : _context.t1 === "vscode" ? 47 : 47;
            break;
          case 45:
            output = (0, _formatters.formatNeosnippet)(data);
          ...
          case 48:
            ...
            debug && console.log(_util["default"].inspect(data, {
              showHidden: false,
              depth: null,
              colors: true
            }));
  ...
  return function sassdocToSnippets(_x) {
